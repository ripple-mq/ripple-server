...
const (
	BootstrapService_CreateBucket_FullMethodName = "/bootstrapserver.BootstrapService/CreateBucket"
)
...
func (c *bootstrapServiceClient) CreateBucket(ctx context.Context, in *CreateBucketReq, opts ...grpc.CallOption) (*CreateBucketResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateBucketResp)
	err := c.cc.Invoke(ctx, BootstrapService_CreateBucket_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedBootstrapServiceServer) CreateBucket(context.Context, *CreateBucketReq) (*CreateBucketResp, error) {
...
func _BootstrapService_CreateBucket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateBucketReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BootstrapServiceServer).CreateBucket(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BootstrapService_CreateBucket_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BootstrapServiceServer).CreateBucket(ctx, req.(*CreateBucketReq))
	}
...
var BootstrapService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bootstrapserver.BootstrapService",
	HandlerType: (*BootstrapServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CreateBucket",
			Handler:    _BootstrapService_CreateBucket_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/internal_broker_server.proto",
}
